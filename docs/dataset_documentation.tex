...
\author{Kamal} % TODO: replace with your name / affiliation
\date{\today}
...
\begin{abstract}
This document describes a dataset of single-item dry waste images collected in 2020 using a purpose-built automated waste-sorting device, along with a baseline image classification benchmark trained on the data. The dataset contains 2{,}043 images across three material categories: metal, paper, and plastic. A transfer-learning baseline (MobileNetV2, partially fine-tuned) achieves 82.3\% overall accuracy on a held-out validation split. This document is intended to accompany the public release of the dataset and serves as its dataset card / datasheet.
\end{abstract}
...
To validate that the dataset carries meaningful, learnable signal, a baseline image classifier was trained and evaluated.
...
The best model, selected by validation accuracy, achieved \textbf{82.3\% overall accuracy} on the held-out validation set. Table~\ref{tab:report} and Figure~\ref{fig:curves} give per-class and training-progression detail.
...
% TODO: replace with your actual name, year, and DOI/URL once published (e.g. via Zenodo).
\begin{quote}
\itshape
[Author Name]. (2026). Dry Waste Image Classification Dataset
(Metal, Paper, Plastic) [Data set]. [Platform / DOI / URL].
\end{quote}
...
% TODO: add repository URL once published, e.g.:
% \url{https://github.com/USERNAME/REPO}

% ============================================================
\section{Contact}
% ============================================================
% TODO: add contact email / GitHub / preferred contact method for questions,
% corrections, or collaboration inquiries.
